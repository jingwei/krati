...
import krati.mds.array.LongArray;
import krati.mds.array.ShortArray;
import krati.mds.impl.array.DynamicIntArrayImpl;
...
public class TestDynamicArray extends AbstractTest
{
  ...
  public void testDynamicIntArray() throws Exception
  {
    ...
    IntArray array1 = new DynamicIntArrayImpl(TEST_DATA_DIR,
                                              subArrayShift,
                                              maxEntrySize,
                                              maxEntries);
    ...
    IntArray array2 = new DynamicIntArrayImpl(TEST_DATA_DIR,
                                              subArrayShift,
                                              maxEntrySize,
                                              maxEntries);
    ...
    IntArray array3 = new DynamicIntArrayImpl(TEST_DATA_DIR,
                                              subArrayShift,
                                              maxEntrySize,
                                              maxEntries);
  ...
  public void testDynamicLongArray() throws Exception
  {
    ...
    // Create the first long array and do random updates
    LongArray array1 = new DynamicLongArrayImpl(TEST_DATA_DIR,
                                                subArrayShift,
                                                maxEntrySize,
                                                maxEntries);
    ...
    // Create the second array, which should load data from cache
    LongArray array2 = new DynamicLongArrayImpl(TEST_DATA_DIR,
                                                subArrayShift,
                                                maxEntrySize,
                                                maxEntries);
    assertTrue("array2.getHWMark() is greater than array1.getHWMark()", array2.getHWMark() <= array1.getHWMark());
    ...
    // Create the third array, which should load data from cache
    LongArray array3 = new DynamicLongArrayImpl(TEST_DATA_DIR,
                                                subArrayShift,
                                                maxEntrySize,
                                                maxEntries);
    assertTrue("array3.getHWMark() is greater than array1.getHWMark()", array3.getHWMark() <= array1.getHWMark());
  ...
  public void testDynamicShortArray() throws Exception
  {
    ...
    // Create the first long array and do random updates
    ShortArray array1 = new DynamicShortArrayImpl(TEST_DATA_DIR,
                                                  subArrayShift,
                                                  maxEntrySize,
                                                  maxEntries);
    ...
    // Create the second array, which should load data from cache
    ShortArray array2 = new DynamicShortArrayImpl(TEST_DATA_DIR,
                                                  subArrayShift,
                                                  maxEntrySize,
                                                  maxEntries);
    assertTrue("array2.getHWMark() is greater than array1.getHWMark()", array2.getHWMark() <= array1.getHWMark());
    ...
    // Create the third array, which should load data from cache
    ShortArray array3 = new DynamicShortArrayImpl(TEST_DATA_DIR,
                                                  subArrayShift,
                                                  maxEntrySize,
                                                  maxEntries);
    assertTrue("array3.getHWMark() is greater than array1.getHWMark()", array3.getHWMark() <= array1.getHWMark());
