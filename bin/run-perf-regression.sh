...
mvn test -Dtest=TestStaticStoreChannel -Dkrati.test.jvm.args="-Xloggc:target/logs/krati.gc -XX:+PrintGCDetails" -Dkrati.test.keyCount=10000000 -Dkrati.test.numReaders=4 -Dkrati.test.hitPercent=10 -Dkrati.test.initLevel=10 -Dkrati.test.runTimeSeconds=900

mvn test -Dtest=TestDynamicStoreChannel -Dkrati.test.jvm.args="-Xloggc:target/logs/krati.gc -XX:+PrintGCDetails" -Dkrati.test.keyCount=10000000 -Dkrati.test.numReaders=4 -Dkrati.test.hitPercent=10 -Dkrati.test.initLevel=10 -Dkrati.test.runTimeSeconds=900
